...
export class GradingController {
     ...
     */
    @Get('modulo/:moduloId/categorias')
    getCategorias(@Param('moduloId') moduloId: string, @Query('turnoId') turnoId?: string) {
    ...
    createCategoria(
        ...
        @Body() body: { nombre: string; peso: number; turnoId?: string; esEvalFinal?: boolean },
        @Request() req: any,
    ) {
    ...
    updateCategoria(
        ...
        return this.gradingService.actualizarCategoria(req.user.id, moduloId, id, body);
    }
