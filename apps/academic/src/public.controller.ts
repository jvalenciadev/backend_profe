...
export class PublicController {
    ...
    async getLandingPageData(@Query('tenant') tenant?: string) {
        ...
        const [profe, eventos, programas, comunicados, blogs, galerias, sedes, cargos] = await Promise.all([
        ...
        return { profe, eventos, programas, comunicados, blogs, galerias, sedes, cargos };
    }
