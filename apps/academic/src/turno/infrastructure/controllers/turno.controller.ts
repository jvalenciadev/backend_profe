...
export class TurnoController {
  ...
  @Get()
  @CheckPolicies((ability: any) => ability.can('read', 'Turno'))
  ...
  @Post()
  @CheckPolicies((ability: any) => ability.can('create', 'Turno'))
  create(@Body() data: any, @Req() req: any) {
    return this.createTurnoUseCase.execute(data, req.user?.id, req.user?.tenantId);
  }

  @Put(':id')
  @CheckPolicies((ability: any) => ability.can('update', 'Turno'))
  ...
  @Delete(':id')
  @CheckPolicies((ability: any) => ability.can('delete', 'Turno'))
