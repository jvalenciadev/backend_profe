import { EventoPregunta } from '../entities/evento-pregunta.entity';

export const EVENTOPREGUNTA_REPOSITORY = 'EVENTOPREGUNTA_REPOSITORY';

export interface IEventoPreguntaRepository {
