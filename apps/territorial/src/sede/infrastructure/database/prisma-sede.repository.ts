...
export class PrismaSedeRepository implements ISedeRepository {
  ...
  private mapToPrisma(data: any): any {
    ...
    if (data.nombreAbre !== undefined) { prismaData.nombreAbreviado = data.nombreAbre; delete prismaData.nombreAbre; }
    if (data.nombreResp1 !== undefined) { prismaData.nombreResponsable1 = data.nombreResp1; delete prismaData.nombreResp1; }
    if (data.cargoResp1 !== undefined) { prismaData.cargoResponsable1 = data.cargoResp1; delete prismaData.cargoResp1; }
    if (data.imagenResp1 !== undefined) { prismaData.imagenResponsable1 = data.imagenResp1; delete prismaData.imagenResp1; }
    if (data.nombreResp2 !== undefined) { prismaData.nombreResponsable2 = data.nombreResp2; delete prismaData.nombreResp2; }
    if (data.cargoResp2 !== undefined) { prismaData.cargoResponsable2 = data.cargoResp2; delete prismaData.cargoResp2; }
    if (data.imagenResp2 !== undefined) { prismaData.imagenResponsable2 = data.imagenResp2; delete prismaData.imagenResp2; }
    if (data.whatsapp !== undefined) { prismaData.grupoWhatsapp = data.whatsapp; delete prismaData.whatsapp; }
