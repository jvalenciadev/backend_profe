...
} from './application/use-cases/get-unidades-educativas.use-case';
import {
  CreateUnidadEducativaUseCase,
  UpdateUnidadEducativaUseCase,
  DeleteUnidadEducativaUseCase,
} from './application/use-cases/crud-unidad-educativa.use-case';
...
@Module({
  ...
  providers: [
    {
      provide: UNIDAD_EDUCATIVA_REPOSITORY,
      useClass: PrismaUnidadEducativaRepository,
    },
    GetUnidadesEducativasUseCase,
    GetUnidadEducativaByIdUseCase,
    CreateUnidadEducativaUseCase,
