...
import { IUnidadEducativaRepository, UnidadEducativaFilters } from '../../domain/repositories/unidad-educativa.repository.interface';
...
export class PrismaUnidadEducativaRepository implements IUnidadEducativaRepository {
    ...
    async findAll(filters: UnidadEducativaFilters = {}): Promise<{ data: UnidadEducativa[]; total: number }> {
    ...
    async update(id: string, data: any): Promise<UnidadEducativa> {
        const { id: _, distrito: __, createdAt: ___, updatedAt: ____, ...rest } = data;
