...
export class BancoProfesionalController {
    ...
    @CheckPolicies(ability => true)
    updatePosgrado(@Param('posgradoId') posgradoId: string, @Body() data: any, @Req() req: any) {
    ...
    @CheckPolicies(ability => true)
    updateProduccion(@Param('produccionId') produccionId: string, @Body() data: any, @Req() req: any) {
        return this.service.updateProduccion(produccionId, data, req.user.id);
    }

    @Delete('produccion/:produccionId')
    @CheckPolicies(ability => true)
    removeProduccion(@Param('produccionId') produccionId: string, @Req() req: any) {
