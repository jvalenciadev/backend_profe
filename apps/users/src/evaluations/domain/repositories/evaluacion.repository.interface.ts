import { EvaluacionAdmin, EvaluacionPeriodo } from '../entities/evaluacion.entity';
...
export interface IEvaluacionRepository {
    ...
    // Evaluaciones
    create(data: CreateEvaluacionData & { puntajeTotal: number; codigoVerificacion: string; qrCode: string; cargoId?: string | null }): Promise<EvaluacionAdmin>;
    ...
    existsActiveForUserInPeriodo(userId: string, periodoId: string): Promise<boolean>;
