...
export class EvaluationsController {
    ...
    async findEvaluaciones(@Req() req: any, @Query('periodoId') periodoId?: string) {
        return this.evaluationsService.findEvaluaciones(req.user.tenantId, periodoId);
    }
    ...
    async createEvaluation(@Body() body: any, @Req() req: any) {
        ...
        return this.evaluationsService.createEvaluation(data, responsableTenantId, req.user.id);
    }
