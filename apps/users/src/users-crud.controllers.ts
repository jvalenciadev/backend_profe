...
@Injectable()
export class PersonasService extends GenericCrudService<any> {
  constructor(p: PrismaService) {
    super(p, 'mapPersona', true, true);
  }
}
@Injectable()
export class AreasService extends GenericCrudService<any> {
  constructor(p: PrismaService) {
    super(p, 'areaTrabajo');
  }
}
@Injectable()
export class GenerosService extends GenericCrudService<any> {
  constructor(p: PrismaService) {
    super(p, 'genero');
  }
}
