...
export class ManagePosgradoUseCase {
    ...
    async add(userId: string, data: any, currentUserId: string): Promise<any> {
        return this.repository.addPosgrado({ ...data, id: userId, updatedBy: currentUserId });
    }

    async update(posgradoId: string, data: any, currentUserId: string): Promise<any> {
        return this.repository.updatePosgrado(posgradoId, { ...data, updatedBy: currentUserId });
    }
...
export class ManageProduccionUseCase {
    ...
    async add(userId: string, data: any, currentUserId: string): Promise<any> {
        return this.repository.addProduccion({ ...data, id: userId, updatedBy: currentUserId });
    }

    async update(produccionId: string, data: any, currentUserId: string): Promise<any> {
        return this.repository.updateProduccion(produccionId, { ...data, updatedBy: currentUserId });
    }
