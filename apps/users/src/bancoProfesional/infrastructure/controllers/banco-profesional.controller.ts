...
export class BancoProfesionalController {
    ...
    @Patch(':id/aprobar')
    aprobar(@Param('id') id: string, @Body() data: any, @CurrentUser() user: any) {
    ...
    // --- Posgrados ---
    @Post(':id/posgrados')
    addPosgrado(@Param('id') id: string, @Body() data: any, @CurrentUser() user: any) {
        return this.managePosgradoUseCase.add(id, data, user.id);
    }

    @Put('posgrados/:posgradoId')
    updatePosgrado(@Param('posgradoId') posgradoId: string, @Body() data: any, @CurrentUser() user: any) {
    ...
    // --- Producción ---
    @Post(':id/produccion')
    addProduccion(@Param('id') id: string, @Body() data: any, @CurrentUser() user: any) {
        return this.manageProduccionUseCase.add(id, data, user.id);
    }

    @Put('produccion/:produccionId')
    updateProduccion(@Param('produccionId') produccionId: string, @Body() data: any, @CurrentUser() user: any) {
